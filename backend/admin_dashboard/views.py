    ...
    def update_stock(self, request, pk=None):
        ...
        with transaction.atomic():
            try:
                ...
                raise NotFound("Product item does not exist.") from exc

            self.check_object_permissions(request, product_item)
            product_item.qty_in_stock = serializer.validated_data["qty_in_stock"]
            product_item.save(update_fields=("qty_in_stock",))
