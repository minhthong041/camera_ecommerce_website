...
import OrderLineReviewForm from "../components/OrderLineReviewForm";
          ...
          return (
            <article key={line.id} className="py-5">
              ...
              {statusName === "delivered" && (
                <OrderLineReviewForm key={`${line.id}-${line.review?.id || "new"}-${line.review?.rating || 0}-${line.review?.comment || ""}`} line={line} orderId={id} />
              )}
            </article>
          );
        })}
